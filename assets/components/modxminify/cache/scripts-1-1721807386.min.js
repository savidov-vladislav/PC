...
"use strict";window.onload=function(){var e,t,n,o,i,r,s,c,d;function l(){if(!0===i.matches)void 0!==o&&o.destroy(!0,!0);else if(!1===i.matches)return void(o=new Swiper(".team__slider-container",{spaceBetween:20,loop:!0,slidesPerView:1,breakpoints:{520:{slidesPerView:2},660:{slidesPerView:3}}}))}function a(){if(!0===s.matches)void 0!==r&&r.destroy(!0,!0);else if(!1===s.matches)return void(r=new Swiper(".repair__slider-container",{spaceBetween:20,loop:!0,slidesPerView:1,breakpoints:{520:{slidesPerView:2},660:{slidesPerView:3}}}))}function p(){if(!0===d.matches)void 0!==c&&c.destroy(!0,!0);else if(!1===d.matches)return void(c=new Swiper(".advantages__slider-container",{spaceBetween:12,loop:!0,slidesPerView:1,navigation:{nextEl:".advantages__slider-next",prevEl:".advantages__slider-prev"},breakpoints:{420:{slidesPerView:2},660:{slidesPerView:3}}}))}!function(){var t=document.querySelectorAll(".js-popup-link"),i=document.querySelector("body"),r=document.querySelectorAll(".lock-padding"),s=!0;if(0<t.length)for(var e=function(e){var o=t[e];o.addEventListener("click",function(e){var t=o.getAttribute("href").replace("#",""),n=document.getElementById(t);(t=n)&&s&&((n=document.querySelector(".popup.popup--opened"))?d(n,!1):function(){var e="".concat(window.innerWidth-document.querySelector(".wrapper").offsetWidth,"px");if(0<r.length)for(var t=0;t<r.length;t++)r[t].style.paddingRight=e;i.style.paddingRight=e,i.classList.add("lock"),s=!1,setTimeout(function(){s=!0},300)}(),t.classList.add("popup--opened"),t.addEventListener("click",function(e){e.target.closest(".popup__content")||d(e.target.closest(".popup"))})),e.preventDefault()})},n=0;n<t.length;n++)e(n);var o=document.querySelectorAll(".close-popup");if(0<o.length)for(var c=0;c<o.length;c++)!function(){var t=o[c];t.addEventListener("click",function(e){d(t.closest(".popup")),e.preventDefault()})}();function d(e,t){t=!(1<arguments.length&&void 0!==t)||t,s&&(e.classList.remove("popup--opened"),t&&(setTimeout(function(){if(0<r.length)for(var e=0;e<r.length;e++)r[e].style.paddingRight="0px";i.style.paddingRight="0px",i.classList.remove("lock")},300),s=!1,setTimeout(function(){s=!0},300)))}document.addEventListener("keydown",function(e){27===e.which&&d(document.querySelector(".popup.popup--opened"))}),Element.prototype.closest||(Element.prototype.closest=function(e){for(var t=this;t;){if(t.matches(e))return t;t=t.parentElement}return null}),Element.prototype.matches||(Element.prototype.matches=Element.prototype.matchesSelector||Element.prototype.webkitMatchesSelector||Element.prototype.mozMatchesSelector||Element.prototype.msMatchesSelector)}(),e=document.querySelector(".sandwich__open-btn"),t=document.querySelector(".sandwich__content"),n=document.querySelector(".sandwich__close-btn"),e.onclick=function(){t.classList.add("sandwich__content--opened")},n.onclick=function(){t.classList.remove("sandwich__content--opened")},document.querySelector(".license__slider-container")&&new Swiper(".license__slider-container",{observer:!0,observeParents:!0,slidesPerView:"auto",spaceBetween:20,loop:!0,navigation:{nextEl:".license__slider-next",prevEl:".license__slider-prev"}}),d=window.matchMedia("(min-width: 769px)"),window.innerWidth<=320&&c&&c.destroy(!1),d.addListener(p),p(),s=window.matchMedia("(min-width: 769px)"),window.innerWidth<=320&&r&&r.destroy(!1),s.addListener(a),a(),i=window.matchMedia("(min-width: 860px)"),window.innerWidth<=320&&o&&o.destroy(!1),i.addListener(l),l(),document.querySelector(".reviews-slider")&&new Swiper(".reviews-slider__container",{observer:!0,observeParents:!0,slidesPerView:"auto",spaceBetween:30,loop:!0,navigation:{nextEl:".reviews-slider__next"},breakpoints:{320:{spaceBetween:15},550:{}}}),document.querySelectorAll(".faq__item").forEach(function(e){e.onclick=function(){e.classList.toggle("faq__item--opened")}})};
...
$(document).ready(function(){$('input[name="phone"]').mask("+7 (999) 999-99-99");$(document).on('focus','input',function(e){if(typeof grecaptcha==='undefined'){['https://www.google.com/recaptcha/api.js?render=6LcglI8pAAAAAKSFs3IYYI-Cz1TOGAgzWmVSG2V4',].forEach(function(src){var script=document.createElement('script');script.src=src;script.async=true;script.onload=function(){grecaptcha.ready(function(){grecaptcha.execute('6LcglI8pAAAAAKSFs3IYYI-Cz1TOGAgzWmVSG2V4',{action:"order"}).then(function(token){var captchaForms=document.querySelectorAll('form');if(captchaForms.length>0){captchaForms.forEach(function(el){var hiddenInput=document.createElement('input');hiddenInput.type='hidden';hiddenInput.name='token';hiddenInput.value=token;el.appendChild(hiddenInput);})}});});};document.head.appendChild(script);});}});if($('.models__item__box').length>0){var modelsCount=$('.models__item__box').length;if($(window).width()<=890){if(modelsCount>4){$('.models__footer').addClass('active');}}else{if(modelsCount>8){$('.models__footer').addClass('active');}}}
if($('.models_lite_cont').length>0){var modelsCount=$('.models_lite_cont').length;if($(window).width()<=890){if(modelsCount>6){$('.models__footer-lite').addClass('active');}}else{if(modelsCount>12){$('.models__footer-lite').addClass('active');}}}
$(".models__footer a").click(function(){$(".models__list").toggleClass('active');return false;});$(".models__footer-lite a").click(function(){$(".models__list-lite").toggleClass('active');console.log('123');return false;});$(".js-popup-link-question").click(function(){$("#popup-question").addClass('popup--opened');return false;});$('.price_cart_row').click(function(){$(this).parent().toggleClass("price_cart_container__item--opened");$(this).parent().toggleClass("price_cart_container__item--opened-mobile");});document.querySelector(".repair__slider--js")&&770<$(window).width()&&new Swiper(".repair__slider-container",{observer:!0,observeParents:!0,slidesPerView:"auto",spaceBetween:12,loop:!0,navigation:{nextEl:".repair__slider-next"}}),$(".location__list-all").click(function(){var e;return $(this).parent().parent().toggleClass("active"),$(this).parent().parent().hasClass("active")||((e=$("#location").offset().top),$("body,html").animate({scrollTop:e},100)),!1;}),$(document).on('click','.js-popup-link-btn',function(){return $("#popup-callback").addClass("popup--opened"),!1;}),$(".js-popup-link-question_").click(function(){return $("#popup-quest").addClass("popup--opened"),!1;}),$(".uslugi-more-btn--js").click(function(){return($(this).hasClass("active")?($(this).removeClass("active"),$(".services__list").removeClass("active"),$(this).text("Все услуги")):($(this).addClass("active"),$(".services__list").addClass("active"),$(this).text("Скрыть услуги")),!1);}),$(".btn_service_more a").click(function(){return($(this).parent().parent().hasClass("active")?($(this).parent().parent().removeClass("active"),$(this).parent().parent().removeClass("active"),$(this).text("Все услуги")):($(this).parent().parent().addClass("active"),$(this).parent().parent().addClass("active"),$(this).text("Скрыть услуги")),!1);}),$(".broke__footer a").click(function(){var e;return($(this).hasClass("active")?($(this).removeClass("active"),$(".broke__list").removeClass("active"),$(this).text("Все неисправности"),(e=$("#broke").offset().top),$("body,html").animate({scrollTop:e},100)):($(this).addClass("active"),$(".broke__list").addClass("active"),$(this).text("Скрыть неисправности")),!1);}),$.fn.extend({ajaxOrder:function(o){o=$.extend({fieldsClear:'input[type="text"], textarea, select',preloaderClass:"ajax-loading",onSuccess:function(e,s){},onError:function(e){}},o);var r=!1;$(this).on("submit",function(t){var e=$(t.target),s=e.find(o.fieldsClear),pol=$(e).find('input[name="phone"]').val();a=e.find(":submit");t.preventDefault(),r||((r=!0),$.ajax({cache:!1,async:!1,type:"post",url:"/order_ajax",dataType:"json",data:e.serialize(),beforeSend:function(){a.addClass(o.preloaderClass);},success:function(e){o.onSuccess(t.target,e),tret=t.target,console.log(tret);window.send_calltouch(pol);s.val(""),0==e.status?($(".popup").removeClass("popup--opened"),$("#popup-error").addClass("popup--opened")):($(".popup").removeClass("popup--opened"),$("#popup-success").addClass("popup--opened"),ym(78268993,"reachGoal","OrderDone"));},error:function(e,s,a){o.onError(t.target),$(".popup").removeClass("popup--opened"),$("#popup-error").addClass("popup--opened");},complete:function(){a.removeClass(o.preloaderClass);},}),(r=!1));});},}),$(".callback-form").ajaxOrder(),$(".cost__form").ajaxOrder();if($('.portfolio__slider-container').length>0){var mainSwiper=new Swiper('.portfolio__slider-container',{slidesPerView:1,spaceBetween:0,centeredSlides:false,observer:!0,observeParents:!0,loop:!0,navigation:{nextEl:'.uploaded-in-next',prevEl:'.uploaded-in-prev',},breakpoints:{640:{slidesPerView:2,spaceBetween:30},1000:{slidesPerView:3,spaceBetween:30}}});var mainSecondSwiper=new Swiper('.gallery__slider-container',{slidesPerView:1,spaceBetween:0,centeredSlides:false,observer:!0,observeParents:!0,loop:!0,navigation:{nextEl:'.next-btn',prevEl:'.prev-btn',}});}
$("a.broke__item.js-popup-link").click(function(){var nam_cart=$(this).find('.broke__item-title').text();$('#popup-price .popup__title').text(nam_cart);var nam_price=$(this).find('.broke__item-price span').text();$('#order_info_price').text(nam_price);var id=$(this).data('id')||0;$(".price_container_modal").load("/assets/ajax.php",{action:"getContent",id:id});});$('.head-ind').click(function(){$(this).next().slideToggle();$(this).toggleClass('active');});$nav=$('.header__wrap');$window=$(window);$h=$nav.offset().top;$window.scroll(function(){if($window.scrollTop()>$h){$nav.addClass('fixed');}else{$nav.removeClass('fixed');}});});
/*! lazysizes - v5.3.2 */
